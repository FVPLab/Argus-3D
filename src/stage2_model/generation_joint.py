...
class Generator3D_Stage2(object):
    ...
    def generate_mesh_stage2(self, data, return_stats=True):
        ...
        c_quantized = self.model.batch_predict_autoregressive(bs,device)    # B x C x reso x reso x reso
        ...
        print('Generate Joint Baseline')
        # c_quantized = self.model.batch_test_3plane(bs, device, 'xz')
